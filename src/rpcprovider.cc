...
void RpcProvider::NotifyService(google::protobuf::Service *service)
{
    ...
    {
        //j获取服务对象指定下标方法的描述   UserService Login
...
/* 
在框架内部，rpcprovider和rpcconsunmer协商好通信用的protobuf数据类型
                                ...
                                muduo::net::Buffer* buffer, muduo::Timestamp)
{
    ...
    google::protobuf::Service* service  = it->second.m_service;//获取service对象和method对象   new username
    const google::protobuf::MethodDescriptor* method = mit->second;//和method对象 login
    ...
    //new userservice.method(controller, request, response , done)
...
void RpcProvider::SendRpcResponse(const muduo::net::TcpConnectionPtr& conn, google::protobuf::Message* response)
{
    ...
    {
        std::cout << "serializa response error" << std::endl;
    }
